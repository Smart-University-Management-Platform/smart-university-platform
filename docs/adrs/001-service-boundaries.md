...
- **API Gateway (`gateway-service`)**
  ...
  - All backend services trust the gateway for authentication by permitting all requests at the Spring Security level, avoiding conflicts between gateway JWT validation and service-level security.
